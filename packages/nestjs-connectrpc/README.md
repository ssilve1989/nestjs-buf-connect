...
```bash
npm install nestjs-connectrpc @connectrpc/connect @connectrpc/connect-node @bufbuild/protobuf
# or
pnpm add nestjs-connectrpc @connectrpc/connect @connectrpc/connect-node @bufbuild/protobuf
# or
yarn add nestjs-connectrpc @connectrpc/connect @connectrpc/connect-node @bufbuild/protobuf
```
...
import { ConnectService, ConnectMethod } from 'nestjs-connectrpc';
...
import { ConnectRpcServerStrategy } from 'nestjs-connectrpc';
